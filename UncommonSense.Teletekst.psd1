#
# Module manifest for module 'UncommonSense.Teletekst'
#
...
@{
    ...
    RootModule        = 'UncommonSense.Teletekst.psm1'
    ...
    GUID              = '1ae0d260-9c96-4dc1-8774-bbe5a3d9f89c'
    ...
    FormatsToProcess  = 'UncommonSense.Teletekst.format.ps1xml'

    # Modules to import as nested modules of the module specified in RootModule/ModuleToProcess
    # NestedModules = @()

    # Functions to export from this module, for best performance, do not use wildcards and do not delete the entry, use an empty array if there are no functions to export.
    FunctionsToExport = 'Get-TeletekstNews', 'Get-TeletekstWeather', 'Get-TeletekstTrafficJam'
